...
const FEATURES = [
  {
    ...
    description: "ראה במקום אחד את הפוליסות, החידושים, החפיפות והמסמכים החשובים שלך",
  },
  {
    icon: Mail,
    title: "גילוי חכם מהמייל",
    description: "חיבור Gmail עוזר ללומי לזהות פוליסות, פרמיות, מסמכים והתראות בלי להתחיל מאפס",
  },
  {
    icon: Users,
    title: "המשפחה שלי",
  ...
  },
  {
    ...
    description: "שאל כל דבר על הביטוחים, הילדים, המסמכים והמיילים הביטוחיים שלך מתוך אותו הקשר",
  },
];
